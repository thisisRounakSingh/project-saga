...
export default function Home() {
  return (
    <div className="min-h-screen bg-background text-foreground font-mono flex flex-col selection:bg-accent selection:text-white">
      {/* Navigation */}
        ...
        <section className="mt-8 border-[3px] border-border bg-inverted-bg text-inverted-fg flex flex-col lg:flex-row mb-16">
          <div className="p-8 lg:p-12 flex-1 lg:max-w-md">
            ...
            <div className="space-y-6 text-sm font-medium opacity-90 leading-relaxed">
              <p>
                A flat, versioned document. Codex writes it, the UI reads it. No
                streaming, no auth, no vendor lock. You can commit it next to
                your README.
              </p>
              <p>
                Every version has: files (with role + business-logic flag),
                edges (imports / spawns / ipc / replaces), stack (with docs URL
                + reason it was added), narration lines, and baked-in Q&A.
              </p>
            </div>
          </div>
